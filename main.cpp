//TODO:
//Take screenshot every 10s (DON'T SAVE THE IMAGE)
//Process image
...
int main()
{
	...
	if (!face_cascade.load("c:/OpenCV-3.1.0/opencv/sources/data/haarcascades/haarcascade_frontalface_alt2.xml")) {
		printf("Error loading cascade file for face");
		return 1;
	}
	if (!eye_cascade.load("c:/OpenCV-3.1.0/opencv/sources/data/haarcascades/haarcascade_eye.xml")) {
